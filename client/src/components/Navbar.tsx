import { DollarSignIcon, FolderEditIcon, GalleryHorizontalIcon, MenuIcon, SparkleIcon, XIcon } from 'lucide-react';
...
export default function Navbar() {
    ...
    // credits start at 0 until fetched from server
            ...
            <div className='max-w-6xl mx-auto flex items-center justify-between bg-black/50 backdrop-blur-md border border-white/4 rounded-2xl p-3'>
                ...
                {!user ? (
                   <div className='hidden md:flex items-center gap-3'>
                      ...
                      className='max-sm:text-xs hidden sm:inline-block'>Get Started
                      </PrimaryButton>
                   </div>
                ) : (
                    <div className='flex gap-2'>
                        ...
                        <UserButton>
                            <UserButton.MenuItems>  
                                ...
                                {<GalleryHorizontalIcon size={14}/>} onClick={()=>navigate('/community')}/>
